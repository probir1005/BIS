...
internal class TabView: UIView {
    ...
    fileprivate var option: CustomPageOption = CustomPageOption()
    ...
    init(isInfinity: Bool, option: CustomPageOption) {
       super.init(frame: CGRect.zero)
        ...
        let constraints = self.getConstraint(itemView: contentView, toItemView: self)
...
//            if !isInfinity {
//                option.tabWidth = UIScreen.main.bounds.width/CGFloat(pageTabItems.count)
//            }
//
...
//                option.tabWidth = UIScreen.main.bounds.width/CGFloat(pageTabItems.count)
//            }
//            self.currentBarView.frame.size = CGSize(width: option.tabWidth!, height: option.tabHeight)
//            self.collectionView.reloadData()
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                self.updateCurrentIndex(self.currentIndex, shouldScroll: false)
            }
...
//        cachedCellSizes.removeAll()
//        if !isInfinity {
//            option.tabWidth = self.bounds.width/CGFloat(pageTabItems.count)
//        }
//
//        self.collectionView.reloadData()
//        DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
...
extension TabView: UICollectionViewDelegateFlowLayout {
    ...
    internal func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if !isInfinity {
            return CGSize(width: UIScreen.main.bounds.width/CGFloat(pageTabItems.count), height: option.tabHeight)
        }
